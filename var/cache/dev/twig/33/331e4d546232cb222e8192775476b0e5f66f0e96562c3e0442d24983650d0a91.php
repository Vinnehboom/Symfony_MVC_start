...
<div class=\"example-wrapper\">
    ...
    <form action=\"";
        // line 14
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("ChangeName");
        echo "\" method=\"post\">
    ...
    <a href=\"";
        // line 25
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getUrl("aboutMe");
        echo "\">Go to about page</a>
</div>
";
    ...
    {
        return array (  123 => 25,  117 => 22,  113 => 21,  103 => 14,  98 => 12,  90 => 6,  80 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"example-wrapper\">
    ...
    <form action=\"{{ path('ChangeName') }}\" method=\"post\">
        <label for=\"name\">Fill in your name</label>
        <input type=\"text\" name=\"name\" id=\"name\">
    </form>
    ...
    <a href=\"{{ url('aboutMe') }}\">Go to about page</a>
</div>
{% endblock %}
", "learning/index.html.twig", "/var/www/html/Symfony_MVC_start/MVC-symfony/templates/learning/index.html.twig");
    }
}
